    ...
    class DBH {
        ...
        public DBH() {
            ...
            try {
                ...
                new View.ProblemDiag("Unable to connect to database, contact the developer/administrator.", "DB001");
           }
        }
        ...
        internal int writeDateRowToDBTable(DataRow newDataRow, string table) {
            ...
            try
            {
                ...
                new View.ProblemDiag(SQLQuery, "CustError");
