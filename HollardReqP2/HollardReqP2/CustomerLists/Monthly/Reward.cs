...
namespace HollardReqP2.CustomerLists.Monthly {
    public class Reward {
        ...
        public String Risk_Base { get; set; }
        public String Risk_GST { get; set; }
        public String Stamp_Duty_P { get; set; }
        public String Stamp_Duty_D { get; set; }
        public String Reward_Fee { get; set; }
        public String Reward_Fee_GST { get; set; }
        public Reward() {
            cItemID = -1;
        }
        public Reward(System.Data.DataRow dr) {
            ReadDataRow(dr);
            cItemID = -1;
        }
        public System.Data.DataRow GenDataRow() {
            ...
            dt.Columns.Add("Risk_Base");
            dt.Columns.Add("Risk_GST");
            dt.Columns.Add("Stamp_Duty_P");
            dt.Columns.Add("Stamp_Duty_D");
            dt.Columns.Add("Reward_Fee ");
            dt.Columns.Add("Reward_Fee_GST");
            ...
            rowData[18] = Risk_Base.ToString();
            rowData[19] = Risk_GST.ToString();
            rowData[20] = Stamp_Duty_P.ToString();
            rowData[21] = Stamp_Duty_D.ToString();
            rowData[22] = Reward_Fee.ToString();
            rowData[23] = Reward_Fee_GST.ToString();
            dt.Rows.Add(rowData);
            return dt.Rows[0];
        }
        ...
        public void ReadDataRow(System.Data.DataRow dr) {
            ...
            Reward_Fee = dr["Reward_Fee "].ToString().Trim();
            Reward_Fee_GST = dr["Reward_Fee_GST"].ToString().Trim();
        }
    }
}
