...
namespace HollardReqP2.CustomerLists.Monthly {
    public class AAPT {
        ...
        public String AAPT_IINET_Fee 	 { get; set; }
        public String AAPT_IINET_Fee_GST	 { get; set; }
        ...
        public AAPT(System.Data.DataRow dr) {
            ReadDataRow(dr);
            cItemID = -1;
        }
        public System.Data.DataRow GenDataRow() {
            ...
            dt.Columns.Add("AAPT_IINET_Fee");
            dt.Columns.Add("AAPT_IINET_Fee_GST");
            ...
            rowData[18] = AAPT_IINET_Fee.ToString();
            rowData[19] = AAPT_IINET_Fee_GST.ToString();
