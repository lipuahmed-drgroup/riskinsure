Public Class ReportMenu
    ...
    Private Sub DeclinedClaimsButton_Click(sender As Object, e As EventArgs) Handles DeclinedClaimsButton.Click
        DeclinedClaims.showdialog(Me.StartDate1_TextBox.Text, Me.EndDate1_TextBox.Text)

    End Sub

    Private Sub ButtonUnderwritingGuidelines_Click(sender As Object, e As EventArgs) Handles ButtonUnderwritingGuidelines.Click
        UnderwritingGuidelines.showdialog(Me.StartDate1_TextBox.Text, Me.EndDate1_TextBox.Text)
    End Sub
End Class