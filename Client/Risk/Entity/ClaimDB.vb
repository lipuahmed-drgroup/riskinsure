...
#Region "SQL Columns"
    ...
    Protected mExcessPaidStatusDate As Date?
    Public Property ExcessPaidStatusDate() As Date?
        Get
            Return mExcessPaidStatusDate
        End Get
        Set(ByVal value As Date?)
            mExcessPaidStatusDate = value
        End Set
    End Property
    Public Property sExcessPaidStatusDate() As String
        Get
            Return strDate(mExcessPaidStatusDate)
        End Get
        Set(ByVal value As String)
            mExcessPaidStatusDate = strDate(value)
        End Set
    End Property

    Protected mRepairerPaidStatusDate As Date?
    Public Property RepairerPaidStatusDate() As Date?
        Get
            Return mRepairerPaidStatusDate
        End Get
        Set(ByVal value As Date?)
            mRepairerPaidStatusDate = value
        End Set
    End Property
    Public Property sRepairerPaidStatusDate() As String
        Get
            Return strDate(mRepairerPaidStatusDate)
        End Get
        Set(ByVal value As String)
            mRepairerPaidStatusDate = strDate(value)
        End Set
    End Property
...
#Region "Update"
    Public Function updateClaim()
        ...
        & "ExcessPaidStatusDate = ?, " _
        & "RepairerPaidStatusDate = ? " _
        ...
        updateCommand.Parameters.AddWithValue("@ExcessPaidStatusDate", nDate(Me.mExcessPaidStatusDate))
        updateCommand.Parameters.AddWithValue("@RepairerPaidStatusDate", nDate(Me.mRepairerPaidStatusDate))
