...
Public Class MoreInfoAccuracyReport

    Private Sub MoreInfoAccuracyReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub FillData()
        Try
            Me.MoreInfoAccuracyReportTableAdapter.Fill(Me.ReportsDataSet.MoreInfoAccuracyReport)
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        Try
            DGVCopy(MoreInfoAccuracyReportDataGridView)
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
    End Sub
